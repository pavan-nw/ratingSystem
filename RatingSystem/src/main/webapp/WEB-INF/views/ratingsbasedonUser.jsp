...
<link type="text/css" rel="stylesheet" href="<c:url value="/styles/button.css"/>">
<title>Home</title>
</head>
<body id="main">
<div class="container">
   ...
   <form action="/RatingSystem/admin/ratingsonuser" method="get">
  </br>
    <div class="form-group">
    <input class="form-control input-sm" name="UserName" id="UserName"  placeholder="Enter User Name">
   </div>  
   <input type="submit"  class="btn btn-info" value="Submit Button">
</form>
</div>
    <c:if test="${ratingcontent}">
